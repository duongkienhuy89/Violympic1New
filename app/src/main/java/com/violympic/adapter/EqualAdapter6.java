...
public class EqualAdapter6 extends BaseAdapter {

    private Context context;
    ArrayList<PhepToan> phepToanArrayList;
    public EqualAdapter6(Context context, ArrayList<PhepToan> phepToanArrayList1)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View gridView = inflater.inflate(R.layout.item_equal_one, null);

        ImageView rl_item_pheptoan_bg=(ImageView) gridView.findViewById(R.id.rl_item_pheptoan_bg_one);
        TextView tv_item_pheptoan = (TextView) gridView.findViewById(R.id.tv_item_pheptoan_one);
        TextView tv_item_pheptoan_one_flag = (TextView) gridView.findViewById(R.id.tv_item_pheptoan_one_flag);
        tv_item_pheptoan.setText("");
        tv_item_pheptoan_one_flag.setText("");
    ...
    if (phepToanArrayList.get(position).getKetqua() < 0) {
        ...
        if (phepToanArrayList.get(position).getKetqua() == -2) {
            if (phepToanArrayList.get(position).getCongthuc().equals("vuong")) {
                // rl_item_pheptoan_bg.setBackgroundResource(R.drawable.hinhvuong);
        ...
        if (phepToanArrayList.get(position).getKetqua() == -3) {
            if (phepToanArrayList.get(position).getCongthuc().equals("tamgiac")) {
                //rl_item_pheptoan_bg.setBackgroundResource(R.drawable.hinhtamgiac);
        ...
        if (phepToanArrayList.get(position).getKetqua() == -4) {
            if (phepToanArrayList.get(position).getCongthuc().equals("sao")) {
                // rl_item_pheptoan_bg.setBackgroundResource(R.drawable.hinhngoisao);
        ...
        if (phepToanArrayList.get(position).getKetqua() == -5) {
            if (phepToanArrayList.get(position).getCongthuc().equals("chunhat")) {
                // rl_item_pheptoan_bg.setBackgroundResource(R.drawable.hinhchunhat);
        ...
        if (phepToanArrayList.get(position).getKetqua() == -6) {
            if (phepToanArrayList.get(position).getCongthuc().equals("ngugiac")) {
                // rl_item_pheptoan_bg.setBackgroundResource(R.drawable.hinhngugiac);
        ...
        if (phepToanArrayList.get(position).getKetqua() == -7) {
            if (phepToanArrayList.get(position).getCongthuc().equals("lucgiac")) {
                // rl_item_pheptoan_bg.setBackgroundResource(R.drawable.hinhlucgiac);
...
{
    tv_item_pheptoan_one_flag.setText(phepToanArrayList.get(position).getCongthuc());
}
