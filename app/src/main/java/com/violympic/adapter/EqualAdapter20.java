...
public class EqualAdapter20 extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tv_item_pheptoan_flag = (TextView) gridView.findViewById(R.id.tv_item_pheptoan_flag);
        ...
        {
            tv_item_pheptoan_flag.setText(phepToanArrayList.get(position).getCongthuc());
        }
