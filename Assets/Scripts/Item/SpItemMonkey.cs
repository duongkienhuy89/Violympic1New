...
public class SpItemMonkey : MonoBehaviour {
    ...
    public void setData(string loai)
    {
        ...
        if (loai.Trim().StartsWith("monkeyhinh"))
        {
        ...
        else
        {
            ...
            if (loai.Trim().StartsWith("tao") || loai.Trim().StartsWith("hoa") || loai.Trim().StartsWith("meo") || loai.Trim().StartsWith("hinhtamgiac") || loai.Trim().StartsWith("hinhvuong") || loai.Trim().StartsWith("hinhtron"))
            {
                setEnHi(this.gameObject.transform.GetChild(11).gameObject);
                this.gameObject.transform.GetChild(11).gameObject.GetComponent<tk2dSprite>().SetSprite(loai);
            }
