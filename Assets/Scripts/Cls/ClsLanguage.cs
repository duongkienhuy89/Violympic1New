...
public class ClsLanguage
{
    ...
    public static string doContentMoney()
    {
        ...
        {
            vaothi = "Lektion 3: Bitte benutzen Sie Ihren Finger. Wahlen Sie, ob Sie die Karte so aufhangen mochten, dass die Zahl oder der Ausdruck in der Tabelle einen numerischen Wert hat oder der Ausdruck auf dem Hook steht.";
        }
